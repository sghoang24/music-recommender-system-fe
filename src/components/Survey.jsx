  ...
  return (
    <form className="mt-6 mb-2 w-full sm:w-96" onSubmit={handleSubmit}>
          ...
          <TButton
            className={`rounded-2xl ${
              selectedGenres.includes(genre)
                ...
                : "outline-1 bg-neutral-600 hover:bg-neutral-600/60"
            }`}
      ...
      <div className="mt-4 p-4 flex justify-end gap-x-4">
        <TButton
          className="rounded-2xl bg-white px-3 py-3 disabled:cursor-not-allowed disabled:opacity-50 text-black font-bold hover:opacity-75 transition"
          onClick={laterClicked}
        >
          Later
        </TButton>
        <TButton
          className="rounded-2xl bg-green-500 border-transparent px-3 py-3 disabled:cursor-not-allowed disabled:opacity-50 text-black font-bold hover:opacity-75 transition"
          type="submit"
        >
          Confirm
        </TButton>
