...
const Home = () => {
  ...
  //     try {
  //       if (state.token) {
  //         const response = await api.get(`/get_recommendation_by_likes/${state.user.id}`)
  ...
  return (
    <div>
      ...
      <div
        className={twMerge(
          `bg-neutral-900 rounded-lg h-[97.6vh] w-[99.8%] overflow-hidden overflow-y-auto`,
          player.activeId && "h-[calc(97.6vh-72px)]"
        )}
      >
        <Header>
          <div className="mb-2">
